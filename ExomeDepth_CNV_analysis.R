...
my.counts <- getBamCounts(bed.frame = exons.hg19,bam.files = c("62366870_S36_realigned.bam","62366892/62366892_S39_realigned.bam","62366902/62366902_S42_realigned.bam","62366906/62366906_S43_realigned.bam","62367045/62367045_S69_realigned.bam","62367048/62367048_S70_realigned.bam"),include.chr = FALSE,referenceFasta = "/mnt/exome/Softwares/anil/human_g1k_v37.fasta")
...
output.file <- 'exome_calls_nagacsv'
write.csv(file = output.file,x = all.exons@CNV.calls,row.names = FALSE)

# To plot a single CNV call:
pdf('MGP_deletion.pdf')
> Once a candidate gene is confirmed to be present in the CNV region, keep changing the start and end coordinates to get only the Gene plot-
